    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-lg">
            ...
            <div class="p-4 border-b flex items-center">
                ...
                <div class="ml-auto">
                    <a href="{{ route('admin.chat.index') }}" class="text-blue-500 hover:text-blue-700 ml-auto">Back to
                        Chats</a>
                </div>
            </div>
            ...
            <div id="messages" class="h-96 overflow-y-auto p-4 space-y-4">
                @foreach($messages as $message)
                    <div class="flex {{ $message->sender_id === auth()->id() ? 'justify-end' : 'justify-start' }}">
                        <div
                            class="{{ $message->sender_id === auth()->id() ? 'bg-blue-500 text-white' : 'bg-gray-200 text-black' }} rounded-lg px-4 py-2 max-w-sm">
            ...
            <div class="p-4 border-t">
                <form id="messageForm" class="flex space-x-2" action="{{ route('admin.chat.send', $receiver->id) }}"
                    ...
                    <button type="submit"
                        class="bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600">Send</button>
                </form>
            </div>
        </div>
    </div>
