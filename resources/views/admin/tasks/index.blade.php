                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">Manage and track all intern tasks</p>
                        </div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex -space-x-2">
                                                @foreach($task->interns->take(3) as $intern)
                                                    <div
                                                        class="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-white text-xs font-bold border-2 border-white">
                                                        {{ strtoupper(substr($intern->user->name, 0, 1)) }}
                                                    </div>
                                                @endforeach
                                                @if($task->interns->count() > 3)
                                                    <div
                                                        class="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center text-gray-600 text-xs font-bold border-2 border-white">
                                                        +{{ $task->interns->count() - 3 }}
                                                    </div>
                                                @endif
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-3">
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-action-open data-url="{{ route('tasks.destroy', $task) }}">
                    ...
                    <div id="deleteModal"
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-lg">
                            ...
                            <p class="text-gray-600">Do you really want to delete this task? This action cannot be
                                undone.</p>
