        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-md rounded-xl p-8">
                <div class="mb-4 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-600">Fill in the details below to add a new admin</p>
                </div>

                <form action="{{ route('admins.store') }}" method="POST" id="create-admin-form" class="space-y-5">
                    @csrf
