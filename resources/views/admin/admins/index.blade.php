                    ...
                    <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-8">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center space-y-3 md:space-y-0 md:space-x-4">
                            ...
                            <a href="{{ route('roles.index') }}"
                                class="inline-block text-blue-600 hover:text-blue-800 font-medium py-2 px-4 rounded-md hover:bg-blue-50 transition duration-200">
                                Roles Management
                            </a>
                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700 uppercase tracking-wider">Position</th>
                                    <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700 uppercase tracking-wider">Roles</th>
                                ...
                                @forelse ($admins as $admin)
                                    <tr class="hover:bg-gray-50 transition duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            ...
                                            <form action="{{ route('admins.destroy', $admin) }}" method="POST" class="inline-block"
